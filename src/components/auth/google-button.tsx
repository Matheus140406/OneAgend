...
export function GoogleButton() {
  ...
  async function handleClick() {
    ...
    // o navegador é redirecionado para o Google nesse ponto; loading fica
    // true até a página trocar.
  }

  return (
    <Button type="button" variant="outline" size="lg" disabled={loading} onClick={handleClick} className="w-full">
